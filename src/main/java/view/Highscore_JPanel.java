...
public class Highscore_JPanel extends JPanel {
    ...
    public Highscore_JPanel(){
        ...
        for(int i=0;i<10;i++){
            JButton x = new JButton("Người chơi "+String.valueOf(i+1)); //Những thông tin hiển thị trên bảng điểm 
            x.setFont(font);
            x.addActionListener(event ->{
                JOptionPane.showMessageDialog(null,"Player additional info"); // Hiển thị thêm thông tin về 1 người chơi qua 1 cửa sổ msg
